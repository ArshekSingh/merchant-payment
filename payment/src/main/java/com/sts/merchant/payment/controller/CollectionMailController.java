...
public class CollectionMailController {
    ...
    @PostMapping("/downloadCollectionDetailExcel/{loanId}")
    public void generateExcelOfCollectionDetail(@PathVariable("loanId") String loanId) {
        collectionMailService.generateExcelForCollectionDetail(loanId);
    }
}
